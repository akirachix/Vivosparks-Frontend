...
const HomePage = () => {
  return (
    <div className="relative h-screen flex items-center justify-center bg-cover bg-no-repeat overflow-hidden" style={{ backgroundImage: 'url("/images/background-image.png")' }}>
      ...
      <div className="relative z-10 text-center text-white px-4 flex flex-col items-center">
        ...
        <Link href="/login"> {/* Wrap button in Link */}
